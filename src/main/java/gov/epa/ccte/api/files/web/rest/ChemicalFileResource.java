package gov.epa.ccte.api.files.web.rest;

import com.epam.indigo.Indigo;
import com.epam.indigo.IndigoObject;
import com.epam.indigo.IndigoRenderer;
import gov.epa.ccte.api.files.domain.ImageFormat;
import gov.epa.ccte.api.files.repository.ChemicalDetailRepository;
import gov.epa.ccte.api.files.web.rest.errors.IdentifierNotFoundProblem;
...
/**
 * REST controller for getting the {@link gov.epa.ccte.api.files.domain.ChemicalDetail}s.
 */
...
public class ChemicalFileResource {
    ...
    @RequestMapping(value = "chemical-file/test", method = RequestMethod.GET)
    String test() {
        return "test";
    }
